<x-guest-layout>
    <div class="flex justify-center items-center">
        <div class="mt-10 mx-auto p-10 md:w-1/3 w-full bg-white">
            ...
            <h2 class="text-[--secondary] text-md font-[300] leading-normal text-center">
            ...
            <form method="POST" action="{{ route('login') }}" class="mt-10">
                ...
                <!-- <div class="flex items-center justify-center mt-4">
                    @if (Route::has('password.request'))
                        <a class="no-underline text-sm text-[--secondary] dark:text-gray-400 hover:text-[--primary] hover:font-semibold dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('password.request') }}">
