                        ...
                        @if($key < 3)
                            <div class="flex w-full min-h-[100px] my-1 items-center justify-between space-x-4">
                                <div class="flex flex-row justify-between w-full">
                                    <div class="flex md:flex-row flex-col md:gap-10 gap-4">
                                        <div>
                                    ...
                                    <div class="my-auto">
                                        <a href="{{ route('profile.show', $item->profile_id) }}" class="bg-[--primary] text-sm text-white py-1 px-2 rounded-full hover:ring-1 hover:ring-[--primary] hover:bg-white hover:text-[--primary] hover:font-semibold">
                                            See Profile
                                        </a>
                                    </div>
                                </div>
